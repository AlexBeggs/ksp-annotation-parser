...
class AnnotationsTest {
    ...
    @JavaTestAnnotations.JavaParametersTestAnnotation(classValue = AnnotationsTest::class)
    @Test
    fun testJavaParametersTestAnnotationDefaults() {
        setupProcessor(
            ...
            assertThat(annotation.longValue).isEqualTo(-6L)
            assertThat(annotation.stringValue).isEqualTo("emptystring")
            assertThat(annotation.classValue).isEqualTo(AnnotationsTest::class)
    ...
    companion object {
        ...
        fun <T : Annotation> setupProcessor(
            ...
            val compilation = KotlinCompilation().apply {
                sources = listOf(
                    SourceFile.fromPath(File("src/test/kotlin/org/abeggs/kspannotations/AnnotationsTest.kt")),
                    SourceFile.fromPath(File("src/test/kotlin/org/abeggs/kspannotations/JavaTestAnnotations.java")),
                )
